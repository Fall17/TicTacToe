...
public class TextAreaView extends BorderPane implements Observer {
  ...
  private class coordinateHandler implements EventHandler<ActionEvent> {
	  public void handle(ActionEvent event) {
			...
			if(!((rowText.getText().equals("0") || rowText.getText().equals("1") || rowText.getText().equals("2") && (columnText.getText().equals("0") || columnText.getText().equals("1") || columnText.getText().equals("2"))))) {
