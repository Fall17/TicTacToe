...
public class IntermediateAI implements TicTacToeStrategy {
	...
	public Point desiredMove(TicTacToeGame theGame) {
		...
		if ((space1 == 'O' && space2 == 'O' || space6 == 'O' && space9 == 'O' || space5 == 'O' && space7 == 'O')
				&& space3 == '_') {
			return new Point(0, 2);
		} else if ((space1 == 'O' && space3 == 'O' || space5 == 'O' && space8 == 'O') && space2 == '_') {
			return new Point(0, 1);
		} else if ((space2 == 'O' && space3 == 'O' || space4 == 'O' && space7 == 'O' || space5 == 'O' && space9 == 'O')
				&& space1 == '_') {
			return new Point(0, 0);
		} else if ((space4 == 'O' && space5 == 'O' || space3 == 'O' && space9 == 'O') && space6 == 'O') {
			return new Point(1, 2);
		} else if ((space1 == 'O' && space9 == 'O' || space2 == 'O' && space8 == 'O' || space3 == 'O' && space7 == 'O'
				|| space4 == 'O' && space6 == 'O') && space5 == 'O') {
			return new Point(1, 1);
		} else if ((space5 == 'O' && space6 == 'O' || space1 == 'O' && space7 == 'O') && space4 == 'O') {
			return new Point(1, 0);
		} else if ((space3 == 'O' && space6 == 'O' || space1 == 'O' && space5 == 'O' || space7 == 'O' && space8 == 'O')
				&& space9 == '_') {
			return new Point(2, 2);
		} else if ((space2 == 'O' && space5 == 'O' || space7 == 'O' && space9 == 'O') && space8 == '_') {
			return new Point(2, 1);
		} else if ((space1 == 'O' && space4 == 'O' || space3 == 'O' && space5 == 'O' || space8 == 'O' && space9 == 'O')
				&& space7 == '_') {
			return new Point(2, 0);
		} else {
		}

		// check if blocking a win is available (same as above code, just looks
		// for spaces X can win instead)
		if ((space1 == 'X' && space2 == 'X' || space6 == 'X' && space9 == 'X' || space5 == 'X' && space7 == 'X')
				&& space3 == '_') {
			return new Point(0, 2);
		} else if ((space1 == 'X' && space3 == 'X' || space5 == 'X' && space8 == 'X') && space2 == '_') {
			return new Point(0, 1);
		} else if ((space2 == 'X' && space3 == 'X' || space4 == 'X' && space7 == 'X' || space5 == 'X' && space9 == 'X')
				&& space1 == '_') {
			return new Point(0, 0);
		} else if ((space4 == 'X' && space5 == 'X' || space3 == 'X' && space9 == 'X') && space6 == 'X') {
			return new Point(1, 2);
		} else if ((space1 == 'X' && space9 == 'X' || space2 == 'X' && space8 == 'X' || space3 == 'X' && space7 == 'X'
				|| space4 == 'X' && space6 == 'X') && space5 == 'X') {
			return new Point(1, 1);
		} else if ((space5 == 'X' && space6 == 'X' || space1 == 'X' && space7 == 'X') && space4 == 'X') {
			return new Point(1, 0);
		} else if ((space3 == 'X' && space6 == 'X' || space1 == 'X' && space5 == 'X' || space7 == 'X' && space8 == 'X')
				&& space9 == '_') {
			return new Point(2, 2);
		} else if ((space2 == 'X' && space5 == 'X' || space7 == 'X' && space9 == 'X') && space8 == '_') {
			return new Point(2, 1);
		} else if ((space1 == 'X' && space4 == 'X' || space3 == 'X' && space5 == 'X' || space8 == 'X' && space9 == 'X')
				&& space7 == '_') {
			return new Point(2, 0);
		} else {
		}

		// if cannot win or block, picks random available space (same code as in
		// RandomAI.java)
